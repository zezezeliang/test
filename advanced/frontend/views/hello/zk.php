...
<div class="top">
    <ul class="">
        <li><a class="nav selected" href="#">客服中心</a></li>
    </ul>
    <div class="login_register">
        ...
        |
        <a href="index.php?r=hello/zoukao">进入直播间</a>
    </div>
</div>
