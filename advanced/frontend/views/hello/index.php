...
function onmessage(data){
  ...
  }else if(msg['type']=="Startlive"){
    msg['msg']=msg['name']+"开启了直播,大家快来看。<a href='javascript:;' id='look' val='"+msg['name']+"' >去这看</a>"
    sendMesg(msg['name'],msg['msg'],msg['time'],msg['img']);
  }else if(msg['type']=="SendLiwu"){
    msg['msg']=msg['name']+"送给主播<img src='"+msg['id']+".jpg' style='width:90px;height:100px;' /> * "+msg['num']
    sendMesg(msg['name'],msg['msg'],msg['time'],msg['img']);
  }
...
<div class="chatbox">
  <div class="chat_top fn-clear">
    ...
    <div class="uinfo fn-clear">
      ...
      <div class="uname">
        ...
        <a href="#" id="invisible">隐身</a><a href="javascript:;" id="start_live" >开始直播</a>
        <ul class="managerbox">
    ...
    <div class="chat_left">
      ...
      <div class="write_box">
        <!-- <textarea id="message" name="message" class="write_area" placeholder="说点啥吧..."></textarea> -->
         <!-- 加载编辑器的容器 -->
      <div><span  ><input type="file" name="f" id="f"><input type="file" name="files" id="files"><a href="index.php?r=hello/lishi">历史消息</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="color:red;">礼物</b>：&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="liwu" id="1" ><b>五角大楼</b></a>&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="liwu" id="2" ><b>白宫</b></a></div>
  ...
  <div class="chat_right_bom">
    <video autoplay id="sourcevid" style="width:190px;height:190px; " ></video>\
...
$(document).ready(function(e) {
  ...
  $('.liwu').click(function(){
    ...
    var liwunum=prompt("请问你要多少？");
    var liwuid =$(this).attr('id');
    ...
    var msg = '{"name":"'+name+'","type":"SendLiwu","toname":"'+look+'","num":"'+liwunum+'","id":"'+liwuid+'","img":"'+img+'"}';
    ws.send(msg);
  ...
  $('#start_live').click(function(){
    var live_ws = new WebSocket("ws://192.168.1.108:10086");
    ...
    live_ws.onopen=function(){
      var msg = '{"name":"'+name+'","type":"Startlive","img":"'+img+'"}';
      ws.send(msg);
      onopen();
    }
    var onopen=function(){
      ...
      if(video.src){
          live_ws.send(canvas.toDataURL("image/jpeg"),0.5);
      }
  ...
  $(document).on('click','#look',function(){
    ...
    var people_ws= new WebSocket("ws://192.168.1.108:10010");
    $(".chat_right_bom").html("<img id='looklook' style='width:190px;height:190px;' />");
    var image = document.getElementById("looklook");
    people_ws.onmessage=function(msg){
      image.src=msg.data;
    }
